   ...
   <div class="admin-content-body">
    	<div class="am-cf am-padding am-padding-bottom-0">
	      <div class="am-fl am-cf">
	        <strong class="am-text-primary am-text-lg">关系信息</strong>
	      </div>
	    </div>
    	...
    	<div class="am-tabs am-margin" data-am-tabs>
	      <ul class="am-tabs-nav am-nav am-nav-tabs">
	        <li class="am-active"><a href="#tab1">关系信息</a></li>
	      </ul>
	    	<div class="am-tabs-bd">
		        <div class="am-tab-panel am-fade am-in am-active" id="tab1">
			        <form class="registerform am-form" id="relaForm" action="${rela == null ? '/rela/addRela' : '/rela/upRela' }" method="post">
			            <input id="relaId" type="hidden" name="rela.id" value="${rela.ID }">
			            <div class="formsub">
			            	<div class="am-g am-margin-top-sm">
				              <div class="am-u-sm-4 am-u-md-2 am-text-right">
				                <label><span class="need">*</span> 关系名称：</label>
				              </div>
				              <div class="am-u-sm-8 am-u-md-4 am-u-end">
				                <input type="text" value="${rela.NAME }" name="rela.name" class="inputxt" 
				                datatype="s2-18" ajaxurl="<%=path %>/rela/validName/${rela.ID}" errormsg="名称至少2个字符,最多18个字符！" />
				            ...
				            <div class="am-g am-margin-top">
				              ...
				              <div class="am-u-sm-12 am-u-md-10">
				                <textarea rows="4" name="rela.remark" placeholder="请使用富文本编辑插件">${rela.REMARK }</textarea>
				              </div>
				            </div>
			                <div class="am-margin">
