		...
		<div class="row">
		    ...
		    <main class="col py-3 bd-content" role="main">
				<div class=" mx-auto py-2">
					<h3 class="mb-3 font-weight-normal text-left">推送列表</h3>
		          	<div class="table-responsive-sm  bg-white border border-light shadow">
			            ...
			            <table class="table table-striped table-hover MymissPerList">
			              	...
			              	<tbody>
			                	...
			                	<tr>
				                  	<td scope="row">${send.ID }</td>
				                  	
				                  	<td><span>${send.TITLE }</span></td>
				                  	<td><p>${send.CONTENT }</p></td>
				                  	<td><span>${send.NAME }</span></td>
				                  	<td><span>${send.RECTIME }</span></td>
				                  	<td>
				                  		<button class="btn btn-info btn-sm my-1" data-toggle="modal"  onclick="del(${send.ID})"><i class="fa fa-minus mr-1"></i>删除</button>
				                  	</td>
			                	</tr>
			                	</c:forEach>
			             	</tbody>
