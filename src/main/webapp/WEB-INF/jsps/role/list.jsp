		...
		<div class="row">
		    ...
		    <main class="col py-3 bd-content" role="main">
				<div class=" mx-auto py-2">
					<h3 class="mb-3 font-weight-normal text-left">角色管理列表</h3>
			            ...
			            <table class="table table-striped table-hover MymissPerList">
			              	...
			              	<tbody>
			                	...
			                	<tr>
				                  	...
				                  	<td><span>${role.CODE }</span></td>
				                  	<td><p>${role.REMARK }</p></td>
				                  	<td>
				                  		<button class="btn btn-info btn-sm my-1" onclick="func(${role.ID})" data-toggle="modal"><i class="fa fa-pencil mr-1"></i>编辑</button>
				                  		<button class="btn btn-info btn-sm my-1" data-toggle="modal"  data-target="#AllotPower"><i class="fa fa-gears mr-1"></i>分配权限</button>
				                  		<button class="btn btn-info btn-sm my-1" data-toggle="modal"  onclick="del(${role.ID})"><i class="fa fa-minus mr-1"></i>删除</button>
				                  	</td>
			                	</tr>
			                	</c:forEach>
			             	</tbody>
