			            ...
			            <table class="table table-striped table-hover MymissPerList">
			              	...
			              	<tbody>
			                	...
			                	<tr>
				                  	...
				                  	<td><span>${user.BLOOD }</span></td>
				                  	<td><span>${user.VIDEONAME }</span></td>
				                  	<td><span>${user.TEL }</span></td>
				                  	<td>
				                  		<button class="btn btn-info btn-sm my-1" onclick="anaByUserCode('${user.USERCODE}','${user.DISID}')"><i class="fa fa-pencil mr-1"></i>View compare</button>
				                  	</td>
			                	</tr>
			                	</c:forEach>
			              	</tbody>
	    	...
	    	<div class="modal-content">
	    		<input type="hidden" id="misId">
	      		<div class="modal-header bg-info text-white">
			        <h5 class="modal-title" id="exampleModalLongTitle"><i class="fa fa-lightbulb-o mr-1"></i>View Compare</h5>
			        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			         	<span aria-hidden="true">&times;</span>
			        </button>
			     </div>
		      	<div class="modal-body text-center">
		        	<h5 class="text-info">Compare：</h5>
