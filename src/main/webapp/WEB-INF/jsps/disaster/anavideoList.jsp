		   ...
		   <c:import url="/common/menu.jsp"></c:import>
		    ...
		    <main class="col py-3 bd-content" role="main">
				<div class=" mx-auto py-2">
					<h3 class="mb-3 font-weight-normal text-left">Analysis list</h3>
		          	<div class="table-responsive-sm  bg-white border border-light shadow">
			            <table class="table table-striped table-hover MymissPerList">
			              	<thead class="bg-info text-white">
				                <tr>
				                 	<th scope="col">Location occur</th>
				                 	<th scope="col">Total number</th>
				                 	<th scope="col">Number of males</th>
				                 	<th scope="col">Number of females</th>
				                 	<th scope="col">Blood A</th>
				                 	<th scope="col">Blood B</th>
				                 	<th scope="col">Blood AB</th>
				                 	<th scope="col">Blood O</th>
				                 	<th scope="col">Injured</th>
				                 	<th scope="col">Slightly injured</th>
				                 	<th scope="col">Seriously injured</th>
				                 	<th scope="col">People rescued</th>
			              	...
			              	<tbody>
			                	...
			                	<tr>
				                  	...
				                  	<td>
				                  		<a class="btn btn-info btn-sm my-1" href="#"><i class="fa fa-pencil mr-1"></i>see details</a>
				                  	</td>
			                	</tr>
			                	</c:forEach>
			              	</tbody>
			            </table>
			            <h4 class="mb-3 font-weight-normal">Disaster summary information</h4>
			            <table class="table table-striped table-hover MymissPerList">
			              	<thead class="bg-info text-white">
				                <tr>
			              	...
			              	<tbody>
			                	<tr>
				                  	...
				                  	<td><span>${record.ALRCOUNT }</span></td>
				                  	<td><span>${record.DIECOUNT }</span></td>
				                  	<td><span>${record.RECUNAME }</span></td>
				                  	<td>
				                  		<a class="btn btn-info btn-sm my-1" href="<%=path %>/disaster/findEchartByDisId/${record.ID }"><i class="fa fa-pencil mr-1"></i>View analysis details</a>
				                  	</td>
			                	</tr>
			              	</tbody>
			            </table>
