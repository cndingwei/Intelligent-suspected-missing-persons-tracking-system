		   ...
		   <c:import url="/common/menu.jsp"></c:import>
		    ...
		    <main class="col py-3 bd-content" role="main">
				<div class=" mx-auto py-2">
					<h3 class="mb-3 font-weight-normal text-left">分析图表</h3>
					<button class="btn btn-info btn-sm my-1" onclick="findAll();"><i class="fa fa-pencil mr-1"></i>分析详情</button>
					<button class="btn btn-info btn-sm my-1" onclick="findAllByVideo();"><i class="fa fa-pencil mr-1"></i>监控统计</button>
