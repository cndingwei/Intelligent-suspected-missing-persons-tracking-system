  ...
  <head>
	...
	<div class="main container-fluid">
	    <form class="form-signin needs-validation" method="post" action="/login" novalidate>
			<h1 class="h2 mb-4 text-info">Invisible Wisdom Missing Tracing System</h1>
            ...
            <div class="d-block my-3">
				...
				<div class="custom-control custom-radio custom-control-inline">
					...
					<label for="personuser" class="custom-control-label">personal</label>
				</div>
				<div class="custom-control custom-radio custom-control-inline">
					<input id="orguser" class="custom-control-input" type="radio" name="userCategory" value="组织"  />
					<label for="orguser" class="custom-control-label"> organization</label>
				</div>
			</div>			
			
			<div id="card" class="col-12">
				<label for="cardID" class="sr-only">身份证</label>
				<input type="text" name="cardId" id="cardID" class="form-control" placeholder="Please enter your ID number" required autofocus >
			...
			<div id="org" class="col-12" style="display:none;">
				...
				<input type="text" name="orgId" id="orgID" class="form-control" placeholder="Please enter a unified social credit code" required autofocus disabled="disabled">
	        	<div class="invalid-tooltip">请输入有效的统一社会信用代码!</div>
			</div>
	        
	        <div class="col-12">
	        	<label for="Password" class="sr-only">密码</label>
	        	<input type="password" name="pwd" id="Password" class="form-control" placeholder="Please enter your password" required>
	        	<div class="invalid-tooltip">请输入有效的密码!</div>
	        </div>

           <div class="custom-control custom-checkbox mb-3  custom-control-inline">
             	<input type="checkbox" class="custom-control-input" id="remberpwd" value="Remember password">
             	<label class="custom-control-label" for="remberpwd">Remember password</label>
            </div>

			<div class="col-12 mb-2">
             	<a href="<%=path %>/register" class="text-info" href="register.html">Register an account</a>
            </div>
            
			<button id="login" class="btn btn-lg btn-info btn-block" type="submit">Login</button>
